...
- Added a regression for Tanya's exact first-call sequence plus stage-tool schema coverage. Strict TypeScript, 117/117 automated tests, and the 25/25 deterministic teaching eval pass. The fix still requires deployment and a second measured carrier call before the live phone behavior gate can pass.
