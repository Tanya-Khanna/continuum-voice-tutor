...
<section class="hero"><div><p class="eyebrow">The call is the classroom</p><h1>A teacher.<br>Any phone.</h1><p class="lead">Call and ask to learn anything. Continuum listens, finds where you are stuck, teaches in your language, and remembers where to continue next time.</p>${cta}<p class="fine">No smartphone. No app. No camera. No internet or mobile data. No reading required. Calls are sponsored only where the local deployment says so.</p></div>
