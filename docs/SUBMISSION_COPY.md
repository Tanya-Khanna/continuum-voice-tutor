...
current evidence is 112/112 automated tests, 25/25 deterministic teaching cases,
...
|---|---|---|
| Runnable Socratic tutor | Compiled-production smoke; clean-clone offline lesson; 112/112 tests; 25/25 deterministic gate | Safe now |
